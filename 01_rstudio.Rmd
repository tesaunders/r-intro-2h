...
Vectors are 1-dimensional series of values, and vectors are the basic building blocks of all data in R.

There are 2 common types of vectors:

1. "character" for strings of characters (letters). Each entry in a character vector is wrapped in quotes.

2. "numeric" vectors contain numbers including decimals. 
