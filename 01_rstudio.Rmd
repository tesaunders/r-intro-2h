...
Vectors are 1-dimensional series of values, and vectors are the basic building blocks of all data in R. All items in a vector must be of the same data type. 
